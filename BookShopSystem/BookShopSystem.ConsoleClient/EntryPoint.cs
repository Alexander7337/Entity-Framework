namespace BookShopSystem.ConsoleClient
{
    ...
    public class EntryPoint
    {
        public static void Main()
        {
            ...
            #region Task 1
            //var titles = context.Books.Where(y => y.ReleaseDate.Value.Year > 2000).Select(t => t).ToList();
            ...
            #region Task 2
            //var authors = context.Authors.Where(b => b.Books.Any(rd => rd.ReleaseDate.Value.Year == 1990)).ToList();
            ...
            #region Task 3
            //var list = context.Authors.OrderByDescending(c => c.Books.Count).ToArray();
